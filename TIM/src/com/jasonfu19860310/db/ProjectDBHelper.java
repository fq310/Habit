...
public class ProjectDBHelper extends DBHelper {
	public ProjectDBHelper(Context context) {
		...
		SQL_CREATE_ENTRIES = "CREATE TABLE " + ProjectEntry.TABLE_NAME + " (" +
				    ...
				    ProjectEntry.COLUMN_NAME_TOTAL_SECONDS + BIGINT_TYPE + COMMA_SEP +
				    ProjectEntry.COLUMN_NAME_TOTAL_FINISHED_SECONDS + BIGINT_TYPE + COMMA_SEP +
				    ProjectEntry.COLUMN_NAME_TIMER_DESTORY_DATE + BIGINT_TYPE + COMMA_SEP +
